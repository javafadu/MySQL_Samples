...
------------------------------------------------------------------------------*/  
select * from personel;
select isim from personel where sirket in ('Honda', 'Ford', 'Tofas');
...
-- tekrarlilar gelmesin istersek sadece union yazariz
-- hepsi gelsin istiyorsak union all yazmamiz gerekiyor
...
------------------------------------------------------------------------------*/ 
select isim, maas,sirket , '5000 den az' as new from personel where maas<5000
union
select isim,maas,sirket, 'Honda olmayan' as new from personel where sirket <>'Honda';
...
------------------------------------------------------------------------------*/
select isim, sehir, 'Mehmet Ozturk sehirleri' as new from personel where isim='Mehmet Ozturk'
union
select isim, sehir , 'Istanbulda calismayan' as new from personel where sehir <> 'Istanbul';
...
select sehir as sehir_telefon, maas as maas_cocuksayisi 
from personel
where id = 123456789
union
