...
select urun_isim, musteri_isim 
    ...
    where exists
    (select urun_isim from mart as mart_tablo where nisan_tablo.urun_isim = mart_tablo.urun_isim);
...
--  isim 'i NULL olan kişilerin isim'ine NO NAME atayınız. kisa soruda eski yolla olur

update insanlar set isim='NO NAME' where isim is null;
-- tabloyu eski haline getirelim
...
/*================================ ORDER BY  ===================================
   ...
   Syntax
   -------
	ORDER BY sutun_adi ASC (ASCENDING)   -- ARTAN
...
-- ilk sayi dahil değil (11 den başla), 2 -> 11 v3 12 yi al
select * from kisiler where id>10 limit 2;
  
--  SORU1: MAAŞ'ı en yüksek 3 kişinin bilgilerini listeleyen sorguyu yazınız.
...
-- SORU2: MAAŞ'a göre sıralamada 4. 5.  6. kişilerin bilgilerini listeleyen sorguyu yazınız.

select * from kisiler order by maas DESC limit 3,3;
-- ilk 3 rakami alma, 4. degeri al diyor
-- 
